...
<html>
    ...
    <body class="hold-transition skin-blue layout-top-nav">
        <%  String Userid = null, Fname = null, Profile_Picture = null, Mail_id = null;
            ...
            PreparedStatement stmt = conn.prepareStatement("select * from questions where AnswerCounts<=1");
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="QuestionsforAnswer.jsp">Answer <span class="sr-only">(current)</span></a></li>
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <section class="content-header">
                        <ol class="breadcrumb">
                            <li><a href="QuestionsforAnswer.jsp"><i class="fa fa-dashboard"></i> Answer</a></li>
                        </ol>
                    </section>
                    <%
