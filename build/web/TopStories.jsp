<%-- 
    Document   : TopStories
    Created on : Nov 1, 2017, 10:29:59 PM
    Author     : Ashutosh
--%>
...
<html>
    ...
    <body class="hold-transition skin-blue layout-top-nav">
        <%  String Userid=null,Fname=null,Profile_Picture=null,Mail_id=null;
            ...
            PreparedStatement stmt = conn.prepareStatement("select * from questions order by LikeCounts desc limit 10");
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="TopStories.jsp">Top Stories<span class="sr-only">(current)</span></a></li>
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <section class="content-header">
                        <ol class="breadcrumb">
                            <li><a href="TopStories.jsp"><i class="fa fa-dashboard"></i> Top Stories</a></li>
                        </ol>
                    </section>
                    <%
